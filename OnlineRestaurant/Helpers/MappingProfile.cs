    ...
    public class MappingProfile:Profile
    {
        ...
        public MappingProfile()
        {
            ...
            CreateMap<Category,CategoryDto>().
                ForMember(c=>c.CategoryUrl,m=>m.MapFrom(i=> Path.Combine(_baseUrl,"images", i.CategoryUrl)));
            CreateMap<Chef, ChefDto>().
                ForMember(c => c.ChefImgUrl, m => m.MapFrom(i => Path.Combine(_baseUrl, "images", i.ChefImgUrl)));
            ...
            CreateMap<Meal, MealDto>().
                ForMember(c => c.MealImgUrl, m => m.MapFrom(i => Path.Combine(_baseUrl, "images", i.MealImgUrl)));
            CreateMap<StaticMealAddition, StaticMealAdditionView>().
                ForMember(c => c.AdditionUrl, m => m.MapFrom(i => Path.Combine(_baseUrl, "images", i.AdditionUrl)));
            ...
            CreateMap<UpdateAccountDto, ApplicationUser>().
                ForMember(des => des.UserImgUrl, m => m.Ignore());
            CreateMap<ApplicationUser, UserView>().
                ForMember(des => des.Role, m => m.Ignore()).
                ForMember(des => des.UserImgUrl, m => m.MapFrom(src=> src.UserImgUrl==null?null:src.UserImgUrl.Contains("googleusercontent")?src.UserImgUrl:Path.Combine(configuration.GetSection("BaseUrl").Value, "images", src.UserImgUrl)));
            ...
            CreateMap<Chef, ChefView>().
                ForMember(des=>des.ChefImgUrl,m=>m.MapFrom(src=> Path.Combine(_baseUrl, "images", src.ChefImgUrl))).
            ...
            CreateMap<Category, CategoryView>().
                  ForMember(c => c.CategoryImg, m => m.MapFrom(src => Path.Combine(_baseUrl, "images", src.CategoryUrl))).
                  ForMember(des => des.NumOfMeals, m => m.MapFrom(src => src.Meals.Count())).
            ...
            CreateMap<MapMealDto, MealByNameView>().
                ...
                ForMember(des => des.Image, m => m.MapFrom(src => Path.Combine(_baseUrl, "images", src.Meal.MealImgUrl))).
            ...
            CreateMap<OrderMeal, OrderMealView>().
                ...
                ForMember(des => des.MealImgUrl, m => m.MapFrom(src => Path.Combine(_baseUrl, "images", src.Meal.MealImgUrl)));
            CreateMap<OrderStaticAddition, OrderStaticAdditionView>().
                ...
                ForMember(des => des.StaticAdditionImgUrl, m => m.MapFrom(src => Path.Combine(_baseUrl, "images", src.StaticMealAddition.AdditionUrl)));
            ...
            CreateMap<Order, AdminOrderView>().
                ForMember(des => des.UserImg, m => m.MapFrom(src => src.User.UserImgUrl == null ? null : src.User.UserImgUrl.Contains("googleusercontent") ? src.User.UserImgUrl : Path.Combine(configuration.GetSection("BaseUrl").Value, "images", src.User.UserImgUrl)
)).
                ForMember(des => des.UserName, m => m.MapFrom(src => src.User.UserName));
            CreateMap<Meal, MealView>().
                ...
                ForMember(des => des.MealImgUrl, m => m.MapFrom(src => Path.Combine(_baseUrl, "images", src.MealImgUrl)));
        }
    }
}
